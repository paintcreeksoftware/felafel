 ...
 * feedback that the click registered. Held for 500 ms — the eye-tracking
 * literature's lower bound for "the user noticed motion."
 */
const MIN_VISIBLE_BUSY_MS = 500;

/**
 * Hold the resolved value of `work` until at least {@link MIN_VISIBLE_BUSY_MS}
 * has elapsed. Use to wrap an IPC call whose `pillBusy` state would
 * otherwise flicker too fast to read.
 *
