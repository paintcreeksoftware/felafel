 ...
 * @param opts - stub-call result
 * @param opts.stdout - stdout the stub should resolve with (default empty)
 * @param opts.error - synchronous error to reject the callback with (default none)
 */
